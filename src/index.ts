...
console.log(chalk.bold('Total number of swaps:', chalk.green(bubbleCount)))
...
console.log(chalk.bold('Total number of swaps:', chalk.green(selectionCount)))
...
console.log(chalk.bold('Total number of swaps:', chalk.green(insertionCount)))
...
console.log('Numbers to sort: ', chalk.red(createArr()))
console.log('Numbers after merge sort: ', chalk.green(mergeSort(createArr(), true)))
console.log('Total swaps: ', mergeCount)
console.log(chalk.italic('Insertion sorting is simple and effective for small arrays, however has a worst case scenario of O(n2)\n'))
